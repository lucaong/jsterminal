...
// If io.inputScope <= 0 the input must be interpreted by JSterminal as a command invocation,
// if io.inputScope > 0 the input is to be relayed to the command that called io.gets (we are in the command scope)
JSterminal.io.inputScope = 0; 
